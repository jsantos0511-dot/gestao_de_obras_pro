...
if not st.session_state.menu_aberto:
    ...
    if os.path.exists("LOGOMARCA.jpeg"):
        ...
        st.markdown("<h2>ROSECON</h2>", unsafe_allow_html=True)
...
if st.session_state.menu_aberto:
    ...
    if pag == 'RESUMO':
        ...
        if obras_dict:
            sel_obra = st.selectbox("Obra Ativa", list(obras_dict.keys()), label_visibility="collapsed")
        ...
        with st.container(border=True):
            ...
            foto = st.camera_input("Capturar recibo", label_visibility="collapsed")
                ...
                if desc and valor > 0:
                    ...
                    if foto:
                        try:
                            ...
                            st.error("Erro no Storage. Crie o bucket 'comprovantes' no Supabase.")
